...
const LoginScreen = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (userDocSnap.exists() && userDocSnap.data().isFirstLogin === false) {
                // Not the first login, go directly to Maps
                navigation.replace('Maps');
            } else {
                // This is the first login (or the flag doesn't exist)
                // Update the flag to false so it won't show again
