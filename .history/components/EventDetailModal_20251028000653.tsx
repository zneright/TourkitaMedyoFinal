...
import {
    ...
    ScrollView,
    ActivityIndicator,
    // The Linking API is no longer needed
} from "react-native";
    ...
    const handleNavigate = async () => {
        ...
        try {
            ...
            if (latitude !== null && longitude !== null) {
                // Create a destination object that the LandmarkProvider can use
                const destination = {
                    name: event.title,
                    latitude: latitude,
                    longitude: longitude,
                ...
                // Set the destination in the context to trigger route calculation
                setSelectedLandmark(destination);

                // Close the current modal
                onClose();

                // Navigate to the Maps screen to show the route
