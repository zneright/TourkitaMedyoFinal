...
export default function CategoryFilter({ selectedCategory, onSelectCategory }: Props) {
    const categories = [
        ...
        { label: "AR Sup", uri: "https://firebasestorage.googleapis.com/v0/b/admin-login-244c5.firebasestorage.app/o/models%2Fmarkers%2Ficons8-hologram-100%20(1).png?alt=media&token=aacfbd20-2ec3-4963-bb11-09c08c416069" },
