...
// ... (EventType and Props interfaces remain the same)
type EventType = {
    id?: string;
    title: string;
    description?: string;
...
const EventDetailModal: React.FC<Props> = ({ visible, onClose, event }) => {
    // ... (hooks and other functions remain the same)
    ...
    const handleNavigate = async () => {
        ...
        try {
            ...
            if (latitude !== null && longitude !== null) {
                ...
                setSelectedLandmark(destination);
                onClose();

                // ✅ CHANGE THIS LINE
                // Navigate to the Maps screen and pass "Events" as a parameter
                navigation.navigate("Maps", { category: "Event" });
    ...
    // ... (rest of the component's JSX and styling remains the same)
