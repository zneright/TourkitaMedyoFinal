...
const SignUpScreen = () => {
    ...
    // Use strings for specific error messages
    ...
    const validateForm = () => {
        ...
        else if (isNaN(ageNum) || ageNum < 18 || ageNum > 100) newErrors.age = "Age must be between 3 and 100.";
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.formCard}>
                    ...
                    <View style={styles.row}>
                        <View style={styles.column}>
                            ...
                            <TextInput
                                ...
                                value={lastName}
                                onChangeText={(val) => handleInputChange(setLastName, "lastName", val)}
                            />
                        ...
                        <View style={styles.column}>
                            ...
                            <TextInput
                                ...
                                value={middleInitial}
                                maxLength={1}
                                onChangeText={(val) => handleInputChange(setMiddleInitial, "middleInitial", val)}
                            />
                    ...
                    <TextInput
                        ...
                        value={firstName}
                        onChangeText={(val) => handleInputChange(setFirstName, "firstName", val)}
                    />
