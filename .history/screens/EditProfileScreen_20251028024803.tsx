...
export default function EditProfileScreen() {
    ...
    const validateForm = () => {
        ...
        else if (isNaN(ageNum) || ageNum < 3 || ageNum > 100) newErrors.age = "Age must be between 18 and 100.";
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.formCard}>
                    ...
                    {/* --- maxLength REMOVED --- */}
                    <FormInput icon="person-outline" label="Middle Initial" value={formData.middleInitial} onChange={(v) => handleInputChange("middleInitial", v)} error={errors.middleInitial} />
