...
const LoginScreen = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            await setDoc(userDocRef, { activeStatus: true }, { merge: true });
            ...
            // --- LOGIC TO CHECK IF INTRO HAS BEEN VIEWED ---
            const userDocSnap = await getDoc(userDocRef);
            if (userDocSnap.exists() && userDocSnap.data().hasViewedIntro) {
    ...
    const handleGuestLogin = async () => {
        ...
        try {
            ...
            // Guests will always see the introduction screen
            navigation.replace('Introduction');
        } catch (error) {
