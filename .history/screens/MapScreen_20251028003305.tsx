...
export default function MapsScreen() {
    ...
    useEffect(() => {
        if (route.params) {
            // Set the category if it's passed
            if (route.params.category) {
                setSelectedCategory(route.params.category);
            }
            // Set the destination to trigger navigation if it's passed
            if (route.params.destination) {
                setSelectedLandmark(route.params.destination);
            }
        }
    }, [route.params]);
    useEffect(() => {
    ...
    const { setNavigationOnly, setSelectedLandmark, duration, distance, showDirection, directionCoordinates } = useLandmark();
