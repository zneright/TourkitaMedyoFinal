...
export default function SelectedLandmarkSheet() {
                    ...
                    <>
                        ...
                        {selectedLandmark.audio && (
                            <View style={styles.section}>
                                ...
                                {/* Simplified Player Button */}
                                <TouchableOpacity
                                    style={styles.audioMinimalPlayer} // New style
                                ...
                                >
                                    ...
                                    <Text style={styles.audioMinimalText}>
                                        {isAudioLoading ? 'Loading Audio Guide...' :
                                            (isPlaying ? 'Tap to Pause Playback' : 'Listen to Historical Guide')}
                                    </Text>
    ...
    // Inside your const styles = StyleSheet.create({...}) block:

    audioMinimalPlayer: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: '#D7CCC8', // A softer, complementary color
        borderRadius: 12,
    ...
    audioMinimalIcon: {
        ...
        height: 34,
        borderRadius: 17,
        backgroundColor: '#6D4C41', // Darker, accent color for the button
        justifyContent: 'center',
        alignItems: 'center',
    },
    audioMinimalText: {
    ...
    // You can remove the old audioPlayerContainer and audioPlayerText styles
});
