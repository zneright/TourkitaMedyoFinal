...
// The useLandmark hook is no longer needed here for setting the landmark
...
const EventDetailModal: React.FC<Props> = ({ visible, onClose, event }) => {
    ...
    // `setSelectedLandmark` is no longer called from this component.
    ...
    const handleNavigate = async () => {
        ...
        try {
            ...
            if (latitude !== null && longitude !== null) {
                ...
                // Navigate to Maps screen with destination parameters
            ...
            console.error("Failed to set navigation route:", error);
            alert("An error occurred while trying to set the navigation route.");
        } finally {
            setLoading(false);
        }
    };
...
const styles = StyleSheet.create({
    ...
    cardBase: { flexDirection: "row", alignItems: "center", backgroundColor: "#f9f9f9", padding: 12, borderRadius: 12, width