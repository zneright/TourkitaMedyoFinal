...
// Import the same date-fns functions as LandmarkMarkers
...
const EventCalendar = () => {
    ...
    // --- MODIFICATION START ---
    // This logic now directly mirrors and completes the logic from LandmarkMarkers.
    const todaysEvents = events.filter((event) => {
        ...
        // 1. Skip events that have already ended completely (from LandmarkMarkers).
        ...
        // 2. Apply the specific recurrence rules from LandmarkMarkers.
        if (recurrence.frequency === "weekly") {
            ...
            // 3. THIS IS THE ADDED LOGIC: For all other cases (daily, multi-day),
            // if we are within the date range, the event is happening today.
...
const styles = StyleSheet.create({
    wrapper: { paddingHorizontal: 22, marginTop: 20, marginBottom: 40 },
