                        ...
                        <View style={styles.section}>
                            ...
                            <Text style={styles.description}>
                                {selectedLandmark.description
                                    // ... (remaining description mapping logic)
                                }
                            </Text>
                            {selectedLandmark.audio && (
                                // REMOVE THIS WRAPPER AND TITLE
                                // <View style={[styles.section, styles.audioSection]}> 
                                //     <Text style={styles.audioSectionTitle}>Audio Guide</Text> 
                                ...
                                >
                                    {/* ... (Audio player contents - keep as is) ... */}
                                </TouchableOpacity>
...
// REPLACE IT WITH THIS:
                        {/* Description and Audio (Combined into one section) */}
                        <View style={styles.section}>
                            <Text style={styles.sectionTitle}>Historical Background</Text>
